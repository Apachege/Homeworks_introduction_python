...
# poem = str(input('Enter poem: ')).split()
# ritm = lambda x: sum(1 for i in x if i in vowels)
# temp = ritm(poem[0])
# if all([ritm(i) == temp for i in poem]):
#     print('Парам пам-пам')
# else:
#     print('Пам парам')
...
# operation = print_operation_table(lambda x, y: x * y)